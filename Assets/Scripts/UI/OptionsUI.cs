...
public class OptionsUI : MonoBehaviour
{
    ...
    public void Show(GameObject showObject, Action onCloseButtonAction = null)
    {
    ...
    private void Hide(GameObject hideObject)
    {
    ...
    {
        Show(pressToRebindKeyTransform.gameObject);
